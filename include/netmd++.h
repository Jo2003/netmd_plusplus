...
Group 5 is part of the even and the odd sector and can therefore be addressed with both sectors.
<pre>
+-------------------------------------------+
|                sector pair                |
+---------------------+---------------------+
...
A cluster is an aggregate of 32 sectors (176 sound groups) representing 2.04 seconds of stereo audio; 
