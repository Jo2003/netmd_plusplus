...
const CNetMdDev::KnownDevices CNetMdDev::smKnownDevices = {
    ...
    { mkDevEntry(0x054c, 0x0036, "Sony NetMD Walkman"       , false, false) },
    { mkDevEntry(0x054c, 0x006F, "Sony NW-E7"               , false, false) },
    { mkDevEntry(0x054c, 0x0075, "Sony MZ-N1"               , false, true ) },
    { mkDevEntry(0x054c, 0x007c, "Sony NetMD Walkman"       , false, false) },
    ...
    { mkDevEntry(0x054c, 0x0101, "Sony LAM"                 , false, false) },
    { mkDevEntry(0x054c, 0x0113, "Aiwa AM-NX1"              , false, true ) },
    { mkDevEntry(0x054c, 0x011a, "Sony CMT-SE7"             , false, false) },
    { mkDevEntry(0x054c, 0x0119, "Sony CMT-SE9"             , false, false) },
    { mkDevEntry(0x054c, 0x013f, "Sony MDS-S500"            , false, false) },
    { mkDevEntry(0x054c, 0x0148, "Sony MDS-A1"              , false, false) },
    ...
    { mkDevEntry(0x054c, 0x0186, "Sony MZ-NH600"            , false, false) },
    { mkDevEntry(0x054c, 0x0187, "Sony MZ-NH600D"           , false, false) },
    ...
    { mkDevEntry(0x04dd, 0x9014, "Sharp IM-DR80/DR420/DR580", true , false) },
    
    // Panasonic
    { mkDevEntry(0x04da, 0x23b3, "Panasonic SJ-MR250"       , false, false) },
    { mkDevEntry(0x04da, 0x23b6, "Panasonic SJ-MR270"       , false, false) },
    
    // Kenwood
    { mkDevEntry(0x0b28, 0x1004, "Kenwood MDX-J9"           , false, false) },
};
